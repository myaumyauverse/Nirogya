...
const diseases = [
  {
    name: "Cholera",
    description:
      "A bacterial infection causing severe diarrhea and dehydration, commonly spread by unsafe water."
  },
  {
    name: "Typhoid",
    description:
      "A bacterial disease spread by contaminated food and water, causing fever, weakness, and abdominal pain."
  },
  {
    name: "Dysentery",
    description:
      "An intestinal infection causing bloody diarrhea, usually caused by unsafe drinking water."
  },
  {
    name: "Hepatitis A",
    description:
      "A viral liver infection transmitted through contaminated water and food."
  },
  {
    name: "Giardiasis",
    description:
      "A parasitic disease causing stomach cramps and diarrhea, spread via unsafe water."
  }
];
